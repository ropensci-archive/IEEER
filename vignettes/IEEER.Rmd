...
The [IEEER package](https://github.com/saulwiggin/IEEER) is not
...
- License:
  [MIT](https://github.com/saulwiggin/IEEER/blob/master/LICENSE)
- Report bugs or suggestions improvements by [submitting an issue](https://github.com/saulwiggin/IEEER/issues) to
  [the GitHub repository for IEEER](https://github.com/saulwiggin/IEEER).
